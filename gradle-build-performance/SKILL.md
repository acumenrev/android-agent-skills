...
Caches configuration phase across builds (AGP 8.0+, optimized in 9.0):
...
### 2. Enable Built-in Kotlin (AGP 9.0+)

AGP 9.0+ includes built-in Kotlin support, removing the need for the `org.jetbrains.kotlin.android` plugin and improving synchronization performance.

```properties
# Enabled by default in AGP 9.0+
...
### 6. Use Non-Transitive R Classes
...
### 13. Use includeBuild for Local Modules
